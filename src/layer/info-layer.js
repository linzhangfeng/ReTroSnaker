var InfoLayer = cc.Layer.extend({
	...
	ctor: function() {
		...
		var actionTo = cc.moveTo(1, cc.p(150, winsize.height-100)).easing(cc.easeBounceOut());
...
//		this.addChild(textField, 20);
		...
		var actionTo = cc.moveTo(1, cc.p(winsize.width/2+50, winsize.height/2-5)).easing(cc.easeElasticOut());
		...
		var actionTo = cc.moveTo(1, cc.p(winsize.width/2+120, winsize.height/2-65)).easing(cc.easeElasticOut());
