...
var RankLayer = cc.Layer.extend({
	...
	ctor: function() {
		...
		var actionTo = cc.moveTo(1, cc.p(winsize.width/2-150, 0)).easing(cc.easeElasticOut());
		...
		var actionTo = cc.moveTo(1, cc.p(winsize.width/2+30, winsize.height-98)).easing(cc.easeElasticOut());
		...
		var actionTo = cc.moveTo(1, cc.p(winsize.width/4+95, winsize.height/2-50)).easing(cc.easeElasticOut());
		...
		var actionTo = cc.moveTo(1, cc.p(winsize.width/4+200, winsize.height/2-50)).easing(cc.easeElasticOut());
		...
		var actionTo = cc.moveTo(1, cc.p(winsize.width/4+305, winsize.height/2-50)).easing(cc.easeElasticOut());
