...
//		this.menu.runAction(actionTo1);
		...
		this.labelCoin = cc.LabelTTF.create("0", "Helvetica", 35);
		...
		this.labelKill = cc.LabelTTF.create("0", "Helvetica", 35);
		...
		this.labelDistance = cc.LabelTTF.create("0", "Helvetica", 35);
